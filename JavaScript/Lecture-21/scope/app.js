...
// 2. Function Scope (var): Variables declared within a function are in the function scope and 
// can only be accessed within that function.
// 3. Block Scope (let, const): Variables declared within a block (e.g., inside an if statement or a loop) 
